...
const MobileMenu = () => {
  return (
    <aside className="w-[85%] mx-auto ">
      <div className="flex space-x-2 text-sm text-[#000066] items-center">
        <BiCategory size={16} />
        <p>Categories</p>
      </div>
      <div className="flex cursor-pointer mt-3 flex-col space-y-4 text-xs">
        {sideData.map((item, i) => (
          <div
            key={i}
